        ...
        <div className="mb-20">
          ...
          <div className="mt-8 bg-blue-50 rounded-2xl p-8 border border-blue-200">
            ...
            <p className="text-gray-700">
              If someone at 848Labs knows you, start there. If not, email us at 
              <span className="relative group cursor-pointer mx-1">
                <span className="font-semibold text-black hover:scale-105 transition-transform duration-300">join@848labs.com</span>
