      ...
      <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-8 bg-blue-50 rounded-2xl p-8 border border-blue-200">
            ...
            <p className="text-gray-700">
              ...
              <span className="relative group cursor-pointer mx-1">
                <span className="font-semibold text-black hover:scale-105 transition-transform duration-300">join@Acantix.org</span>
        ...
        <div className="bg-black rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            CodeSigns is a next-generation technology company focused on building intelligent, balanced, 
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-center space-x-3 text-lg">
              ...
              <span className="relative group cursor-pointer">
                <span className="font-bold hover:scale-105 transition-transform duration-300">join@codesigns.org</span>
