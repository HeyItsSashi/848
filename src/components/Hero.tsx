    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-20">
        ...
        <h1 className="text-6xl md:text-8xl font-bold text-black mb-6 tracking-tight text-left">
          <span className="hover:scale-110 inline-block transition-all duration-300 cursor-pointer hover:drop-shadow-lg hover:text-blue-400">Seven</span>  <span className="hover:scale-110 inline-block transition-all duration-300 cursor-pointer hover:drop-shadow-lg hover:text-blue-400">X</span>
