  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-20">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-black mb-6 tracking-tight text-left">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 mb-8 sm:mb-12 max-w-4xl leading-relaxed text-left">
          <HighlightOnScroll className="font-semibold text-black">Acantix</HighlightOnScroll> is a next-gen AI company turning real-world data into intelligent, automation and Scalable systems,that <HighlightOnScroll className="font-semibold text-black">drive impact.</HighlightOnScroll>.
        </p>
...
See it in Action            </span>
        ...
        <div className="mt-12 sm:mt-16 text-left">
          <p className="text-gray-500 text-xs sm:text-sm mb-4">Explore the thinking behind the technology.
