      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed max-w-4xl mb-12">
            <p>
              The <HighlightOnScroll className="font-semibold text-black">Acantix Stack</HighlightOnScroll> isn't just theory—it's how we operate every day. From product decisions to team dynamics, 
