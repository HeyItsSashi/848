      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple/20 via-golden/10 to-teal/15 relative overflow-hidden mb-20 -mx-6 px-6">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            {/* Icon */}
            <div className="w-24 h-24 bg-golden rounded-3xl flex items-center justify-center mx-auto mb-8 transform hover:scale-110 transition-all duration-500 hover:rotate-6 shadow-2xl">
            ...
            <div className="mb-8 flex items-center justify-center space-x-4 text-gray-600">
              <Globe className="w-6 h-6 animate-pulse text-golden" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
              ...
              <button className="group border-2 border-golden text-golden px-8 py-4 rounded-lg hover:border-golden hover:bg-golden hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95">
        ...
        {/* Solution Categories */}
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-golden mb-12">Enterprise Solution Portfolio</h2>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Link
                to="/#contact"
                onClick={handleScrollToTop}
                className="group bg-white text-golden px-8 py-4 rounded-lg hover:bg-golden hover:text-white transition-all duration-300 flex items-center space-x-2 hover:scale-105 hover:shadow-xl active:scale-95 font-semibold"
              >
