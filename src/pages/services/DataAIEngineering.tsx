...
import { ArrowLeft, TrendingUp, Database, Brain, BarChart3, Zap, Target, LineChart, PieChart } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 group hover:-translate-y-3 hover:border-green-300">
              <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-green-600 group-hover:text-white transition-all duration-300">
        ...
        <div className="mb-20">
          ...
          <div className="relative">
            <div className="grid md:grid-cols-5 gap-6">
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-6 border border-red-200 text-center">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-200 text-center">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-green-50 rounded-2xl p-6 border border-yellow-200 text-center">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200 text-center">
            ...
            <div className="hidden md:block absolute top-16 left-0 right-0 h-0.5 bg-gradient-to-r from-red-300 via-yellow-300 to-blue-300 opacity-50"></div>
          </div>
        </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">1,000+ Stores</span>
                  </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">Multi-Billion AUM</span>
                  </div>
                  <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-medium">Global Operations</span>
                  </div>
                  <p className="text-lg text-gray-700 mb-6">
          ...
          <div className="bg-gray-900 rounded-3xl p-12 text-white">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="text-center">
                <div className="text-4xl font-bold text-orange-400 mb-2">1TB+</div>
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-purple-400 mb-2">Auto-scale</div>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">Apache Spark</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">TensorFlow</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">Kubernetes</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">Apache Kafka</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">PostgreSQL</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">Redis</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">Elasticsearch</span>
                <span className="bg-white bg-opacity-10 px-6 py-3 rounded-full text-sm font-medium">Docker</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              to="/#contact"
              className="group bg-white text-orange-600 px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-300 flex items-center space-x-2 hover:scale-105 hover:shadow-xl active:scale-95 font-semibold"
            >
