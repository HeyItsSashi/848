      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-golden/20 via-sky/10 to-purple/15 relative overflow-hidden mb-20 -mx-6 px-6">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            {/* Icon */}
            <div className="w-24 h-24 bg-rust rounded-3xl flex items-center justify-center mx-auto mb-8 transform hover:scale-110 transition-all duration-500 hover:rotate-6 shadow-2xl">
            ...
            <div className="mb-8 flex items-center justify-center space-x-4 text-gray-600">
              <BarChart3 className="w-6 h-6 animate-pulse text-rust" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
              <button className="group bg-rust text-white px-8 py-4 rounded-lg hover:bg-opacity-80 transition-all duration-300 flex items-center space-x-2 hover:scale-105 hover:shadow-xl active:scale-95">
                <span>Start Your Data Journey</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
              </button>
              
              <button className="group border-2 border-rust text-rust px-8 py-4 rounded-lg hover:border-rust hover:bg-rust hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95">
        ...
        {/* Core Services */}
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-rust mb-12">Complete Data Intelligence Stack</h2>
        ...
        <div className="bg-purple bg-opacity-20 rounded-3xl p-12 text-center relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-4xl font-bold mb-6 text-black">Ready to Transform Your Data Into Intelligence?</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Link
                to="/#contact"
                onClick={handleScrollToTop}
                className="group bg-white text-rust px-8 py-4 rounded-lg hover:bg-rust hover:text-white transition-all duration-300 flex items-center space-x-2 hover:scale-105 hover:shadow-xl active:scale-95 font-semibold"
              >
                <span>Start Your Data Journey</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
              </Link>
