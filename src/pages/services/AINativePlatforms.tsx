      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">40% increase in conversion</span>
                    <span className="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">60% reduction in support costs</span>
                    <span className="bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium">Real-time personalization</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-3xl p-10 border border-green-200">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium">35% efficiency improvement</span>
                    <span className="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium">90% reduction in downtime</span>
                    <span className="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium">Predictive maintenance</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-3xl p-10 border border-purple-200">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-medium">95% fraud detection rate</span>
                    <span className="bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-medium">50% faster loan approvals</span>
                    <span className="bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-medium">Real-time risk assessment</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              to="/#contact"
              className="group bg-white text-blue-600 px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-300 flex items-center space-x-2 hover:scale-105 hover:shadow-xl active:scale-95 font-semibold"
            >
