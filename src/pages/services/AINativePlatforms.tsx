              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Fortune 100</span>
                  </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">Global Operations</span>
                  </div>
                  <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-medium">Multi-State</span>
                  </div>
                  <p className="text-lg text-gray-700 mb-6">
