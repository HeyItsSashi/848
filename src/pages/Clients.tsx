...
const Clients = () => {
  ...
  const clientProjects = [
    ...
    },
    {
      ...
      businessNeed: "24/7 customer support automation and personalised product recommendations to increase sales conversion",
    ...
    },
    {
      ...
      businessNeed: "Streamline production workflows, reduce manual errors, and optimise equipment maintenance scheduling",
    ...
    },
    {
      ...
      businessNeed: "Personalised learning experiences that adapt to individual student progress and learning styles",
